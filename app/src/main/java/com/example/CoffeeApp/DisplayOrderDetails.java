...
coffeeDBHandler dbHandler;
    ...
    public void sendEmail(View view){
        String [] addresses = {"deam245@gmail.com","s3734942@student.rmit.edu.au"};
    ...
    // method to run when the button is clicked to save in SQLite database
    ...
    // method to run when the button is clicked to send the report details
